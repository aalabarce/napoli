...
class ProductoController extends AppBaseController
{
	...
	public function Create()
	{
		try
		{
			...
			$producto->CodProveedor = $this->SafeGetVal($json, 'codProveedor');
			$producto->Descripcion = $this->SafeGetVal($json, 'descripcion');
			$producto->UnidadMedida = $this->SafeGetVal($json, 'unidadMedida');
			$producto->Uxb = $this->SafeGetVal($json, 'uxb');
			$producto->Rubro = $this->SafeGetVal($json, 'rubro');
	...
	public function Update()
	{
		try
		{
			...
			$producto->CodProveedor = $this->SafeGetVal($json, 'codProveedor', $producto->CodProveedor);
			$producto->Descripcion = $this->SafeGetVal($json, 'descripcion', $producto->Descripcion);
			$producto->UnidadMedida = $this->SafeGetVal($json, 'unidadMedida', $producto->UnidadMedida);
			$producto->Uxb = $this->SafeGetVal($json, 'uxb', $producto->Uxb);
			$producto->Rubro = $this->SafeGetVal($json, 'rubro', $producto->Rubro);
