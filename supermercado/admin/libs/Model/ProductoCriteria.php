...
require_once("DAO/ProductoCriteriaDAO.php");

/**
 * The ProductoCriteria class extends ProductoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProductoCriteria extends ProductoCriteriaDAO
{
