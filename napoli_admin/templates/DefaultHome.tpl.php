<?php
	$this->assign('title','Administrador de Productos | Home');
...
?>
	...
	<div class="modal hide fade" id="getStartedDialog">
		...
		<div class="modal-body hidden" style="max-height: 300px">
	...
	<div class="container">
		...
		<div class="hero-unit">
			<h1>Bienvenido</h1>
			<p>En esta aplicación podra agregar, eliminar o editar tanto productos como rubros para el Super Napoli.</p>
		</div>
