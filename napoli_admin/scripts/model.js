/**
 * backbone model definitions for Administrador de Productos
 */
...
/**
 * Producto Backbone Model
 */
model.ProductoModel = Backbone.Model.extend({
...
/**
 * Producto Backbone Collection
 */
model.ProductoCollection = model.AbstractCollection.extend({
	url: 'api/productos',
	model: model.ProductoModel
});

/**
 * Rubro Backbone Model
 */
model.RubroModel = Backbone.Model.extend({
	urlRoot: 'api/rubro',
	idAttribute: 'id',
	id: '',
	nombre: '',
...
/**
 * Rubro Backbone Collection
 */
model.RubroCollection = model.AbstractCollection.extend({
	url: 'api/rubros',
	model: model.RubroModel
});
